  ...
  unit Deltics.Delphi.ProjectFiles.Adapters;
...
interface
  ...
  uses
    SysUtils,
    Deltics.Strings,
    Deltics.Delphi.ProjectFiles.Project;
...
implementation
  ...
  uses
    Deltics.Delphi.ProjectFiles.Adapters.DOF,
    Deltics.Delphi.ProjectFiles.Adapters.DPROJ;
